...
- `ListenToMe/Info.plist` — broaden `NSAppleEventsUsageDescription` to mention Notes.
...
In `ListenToMe/Info.plist`, change the existing `NSAppleEventsUsageDescription` value from:
